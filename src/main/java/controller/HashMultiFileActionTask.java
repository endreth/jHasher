...
public class HashMultiFileActionTask extends Task<HBox> {
    ...
    public HashMultiFileActionTask(List<String> listToHash, String algorithm, CheckBox cbAddSalt) {
...
//        }
        ...
        for (int i = 0; i < this.listToHash.size(); i++) {
            ...
            Label i_name_label = new Label(new File(this.listToHash.get(i)).getName());
