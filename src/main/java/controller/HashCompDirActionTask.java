...
public class HashCompDirActionTask extends Task<HBox> {

    private List<String> listToHash_A;
    private List<String> listToHash_B;
    private final String algorithm;
    private final CheckBox cbAddSalt_cd;
    public ObjectProperty<HBox> hbox1Property;
    public ObjectProperty<HBox> hbox2Property;

    public HashCompDirActionTask(List<String> listToHash_A, List<String> listToHash_B, String algorithm, CheckBox cbAddSalt_cd) {
        this.listToHash_A = listToHash_A;
        this.listToHash_B = listToHash_B;
        this.algorithm = algorithm;
        this.cbAddSalt_cd = cbAddSalt_cd;
...
/*    public List<String> getListToHash_A() {
    ...
    protected HBox call() throws Exception {
        ...
        if (!this.cbAddSalt_cd.isSelected()) {
            isSalted = false;
        ...
        for (int i = 0; i < this.listToHash_B.size(); i++) {
            if(isCancelled()){break;}
